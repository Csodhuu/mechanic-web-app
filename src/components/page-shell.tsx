          ...
          <div className="min-w-0">
            ...
            <div className="mt-1 flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                {description && (
                  <p className="mt-1 max-w-2xl text-[13px] leading-5 text-slate-500 sm:text-sm sm:leading-6">{description}</p>
                )}
              </div>
            </div>
          </div>
    ...
    <div className="rounded-2xl border border-slate-200/80 bg-white p-3 shadow-sm sm:p-4">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="mt-1 break-words text-lg font-bold leading-6 text-slate-950 sm:text-[22px] sm:leading-7">{value}</p>
          {description && <p className="mt-1 text-[13px] leading-5 text-slate-500 sm:text-sm sm:leading-6">{description}</p>}
        </div>
        {icon && (
